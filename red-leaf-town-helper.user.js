...
// @downloadURL  https://cdn.jsdelivr.net/gh/ZGRay00/Red_leaf_town_script@latest/red-leaf-town-helper.user.js
// @updateURL    https://cdn.jsdelivr.net/gh/ZGRay00/Red_leaf_town_script@latest/red-leaf-town-helper.user.js
// @grant        none
...
(function () {
    ...
    window[INSTANCE_KEY] = { version: '2.4.2' };
    ...
    const CONFIG = {
        ...
        aquatic: {
            ...
            ponds: true,              // 鱼塘：自动投苗补到稳态线、捞走超出稳态线的成鱼
        ...
        for (const pond of runtime.state.aquatic?.ponds || []) {
            ...
            if (surplus > 0) {
                try {
                    ...
                    log(`${label}：捞鱼 ×${surplus}（保留稳态线 ${steady} 尾）`);
                } catch (e) {
                    if (shouldAbortTick(e)) throw e;
